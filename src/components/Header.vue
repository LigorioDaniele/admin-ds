	...
	<div class="navbar sticky top-0 z-30 min-h-fit bg-base-100 font-medium shadow-md md:px-[5%] lg:px-[10%]">
		<div class="navbar-start">
			<RouterLink to="/" class="shrink-0 !bg-transparent">
				<img src="@assets/logo.png" class="hidden size-12 cursor-pointer dark:brightness-0 dark:invert md:block"  style="width: 40%; height:100%" />
			</RouterLink>
		...
		<div class="navbar-center">
			<RouterLink to="/" class="shrink-0 !bg-transparent">
				<img src="@assets/logo.png" class="size-12 cursor-pointer dark:brightness-0 dark:invert md:hidden" style="width: 40%; height:100%"/>
			</RouterLink>
